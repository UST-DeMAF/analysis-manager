...
public class PluginRegistrationService {
  ...
  /**
   * Registers a new Plugin. Creates a queue for the new plugin and persists information about the
   * plugin in the configurations database Then, a PluginRegistrationResponse is created and
   * returned.
   *
  ...
  /**
   * Creates a request queue for the plugin with a binding to the analysisTaskRequestExchange. The
   * binding uses a routing key that is based on the technology and analysisType of the plugin.
   * Through registering the queue and the binding at the rabbitAdmin, both entities are created at
   * the message broker.
   *
