...
public class MessagingConfig {
   ...
   */
  @Bean
  public Binding analysisTaskResponseQueueBinding(
      FanoutExchange analysisTaskResponseExchange, Queue analysisTaskResponseQueue) {
    return BindingBuilder.bind(analysisTaskResponseQueue).to(analysisTaskResponseExchange);
  }
