...
public class ModelsService {
  ...
  /**
   * Sends a request to the models service for initializing the technology-specififc deployment
   * model. For that, an entity of type InitializeTechnologySpecificDeploymentModelRequest is
   * created that contains the initial information about the deployment model provided by the user
   * and added as the request body.
   *
  ...
  public String initializeTechnologySpecificDeploymentModel(
    ...
    initializeTechnologySpecificDeploymentModelRequest.setTransformationProcessId(
  ...
  /**
   * Sends a request to the models service for initializing the technology-specififc deployment
   * model. The transformationProcessId is added as a query parameter.
   *
   * @param transformationProcessId
