...
/**
 * Indicates the status of a transformation process. If the transformation process is finished it
 * contains the transformation result.
 */
public class ProcessStatusMessage {
  ...
  /** The transformation result. Defaults to null. */
